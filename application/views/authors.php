    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div  >
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="<?php echo base_url() . "author" ?>">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="align-center text-end text-bg mb-4 mx-6">
                            ...
                            <a class="badge badge-sm bg-gradient-success"
                                href="<?php echo base_url() . "author/add" ?>">ADD Author</a>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $author['id']?>
                                                <a class=" badge badge-sm bg-gradient-success"
                                                    href="<?php echo base_url() . "author/view_author/$id" ?>">Update</a>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $author['id']?>
                                                <a class=" badge badge-sm bg-gradient-danger"
                                                    href="<?php echo base_url() . "author/delete/$id" ?>">Delete</a>
