    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div>
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="<?php echo base_url() . "subtosubcategory" ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-3">
                            <h6>Add Sub-To-Sub-Category</h6>
                        </div>

                        <div class="card-body px-4 pt-0 pb-4">

                            <?php $attributes = array('role' => 'form');
$url = base_url() . "subtosubcategory/add_subtosubcategory";
echo form_open_multipart($url);?>
                            <form action="" method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Sub-to-Sub Category Name</label>
...
$(document).ready(function() {
    $('#category').change(function() {
        ...
        if (category_id != '') {
            $.ajax({
                url: "<?php echo base_url(); ?>subtosubcategory/fetch_sub_categories",
                method: "POST",
                data: {
