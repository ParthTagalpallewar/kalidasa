                    ...
                    <ul class="navbar-nav  justify-content-end">
                        ...
                        <li class="nav-item d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                                ...
                                <a href="authentication/logout" class="d-sm-inline d-none">Log Out</a>
                            </a>
                        </li>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Sub
                                            Categories</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php echo $counts['sub_category'] ?>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">SubToSub Category</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            <?php echo $counts['sub_to_sub_category'] ?>
