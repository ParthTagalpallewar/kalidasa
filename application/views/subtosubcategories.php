                    ...
                    <div class="card mb-4">
                        ...
                        <div class="align-center text-end text-bg mb-4 mx-6">
                            ...
                            <a class="badge badge-sm bg-gradient-success"
                                href="<?php echo base_url() . "subtosubcategory/add" ?>">ADD</a>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0">
                                                    <?php echo $category['sub_cat_name'] ?>
                                                </p>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $category['id']?>
                                                <a class=" badge badge-sm bg-gradient-success"
                                                    href="<?php echo base_url() . "subtosubcategory/view_subtosubcategory/$id" ?>">Update</a>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $category['id']?>
                                                <a class=" badge badge-sm bg-gradient-danger"
                                                    href="<?php echo base_url() . "subtosubcategory/delete/$id" ?>">Delete</a>
