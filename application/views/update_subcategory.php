...
$url = base_url() . "subcategory/update/$category->id";
                            ...
                            <form action="" method=" POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" id="description" name="description"
                                        value="<?php echo $category->description ?>" rows=" 3"></input>

                                </div>


                                <div class=" mb-3">
                                    <label for="subcategory" class="form-label">Category Image</label>
