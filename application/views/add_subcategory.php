...
$url = base_url() . "subcategory/add_subcategory";
                            ...
                            <form action="" method="POST">
                                <div class="mb-3 pb-1 pt-2">
                                    ...
                                    <select id="category" name="category" class="form-select form-select-sm"
                                        ...
                                        <option
                                            value=<?php echo $value['id'] ?><?php echo set_select('category', $category) ?>>
                                            <?php echo $value['name'] ?>
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control form-control-sm" name="subcategory" id="subcategory"
                                        type="file">
                                </div>
                                <br>
