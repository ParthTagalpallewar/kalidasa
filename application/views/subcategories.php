    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div  >
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link  active" href="<?php echo base_url() . "subcategory" ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="align-center text-end text-bg mb-4 mx-6">
                            ...
                            <a class="badge badge-sm bg-gradient-success"
                                href="<?php echo base_url() . "subcategory/add" ?>">ADD</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class=" d-flex px-2 py-1">
                                                    <div>
                                                        <img src="<?php echo
    "http://muktipatha.in/kalidasa/uploads/sub_category/" . $category['image'] ?>"
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $category['id']?>
                                                <a class=" badge badge-sm bg-gradient-success"
                                                    href="<?php echo base_url() . "subcategory/view_subcategory/$id" ?>">Update</a>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $category['id']?>
                                                <a class=" badge badge-sm bg-gradient-danger"
                                                    href="<?php echo base_url() . "subcategory/delete/$id" ?>">Delete</a>
