    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
        ...
        <div  >
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="<?php echo base_url() . "banner" ?>">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="align-center text-end text-bg mb-4 mx-6">
                            ...
                            <a class="badge badge-sm bg-gradient-success"
                                href="<?php echo base_url() . "banner/add" ?>">ADD Banner</a>
                                        ...
                                        <tr>
                                            <td>
                                                <div class=" d-flex px-2 py-1">
                                                    <div>
                                                        <img src="<?php echo
    "http://muktipatha.in/kalidasa/uploads/banner/" . $banner['image'] ?>"
                                                            width="150" height="100"
                                                            alt="<?php echo $banner['image'] ?>">
                                                    </div>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $banner['id']?>
                                                <a class=" badge badge-sm bg-gradient-success"
                                                    href="<?php echo base_url() . "banner/view_banner/$id" ?>">Update</a>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $banner['id']?>
                                                <a class=" badge badge-sm bg-gradient-danger"
                                                    href="<?php echo base_url() . "banner/delete/$id" ?>">Delete</a>
