                ...
                <div class="col-12">
                    <div class="card mb-4">
                        ...
                        <div class="align-center text-end text-bg mb-4 mx-6">
                            ...
                            <a class="badge badge-sm bg-gradient-success" href="<?php echo base_url() . "file/add" ?>">ADD
                                File</a>
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-xs font-weight-bold mb-0"><?php echo $file['name'] ?>
                                                </p>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                <a class=" badge badge-sm bg-gradient-success"
                                                    href="<?php echo base_url() . "file/view/$id" ?>">View</a>

                                            </td>
                                            <td class="align-middle text-center text-sm">
                                                <?php $id = $file['id']?>
                                                <a class=" badge badge-sm bg-gradient-success"
                                                    href="<?php echo base_url() . "file/view_file/$id" ?>">Update</a>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                <a class=" badge badge-sm bg-gradient-danger"
                                                    href="<?php echo base_url() . "file/delete/$id" ?>">Delete</a>
