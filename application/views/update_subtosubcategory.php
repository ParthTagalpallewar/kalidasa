                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-3">
                            <h6>Update Sub-To-Sub-Category</h6>
                        </div>
...
$url = base_url() . "subtosubcategory/update/$subtosubcategory->id";
...
?>
                            ...
                            <form action="" method=" POST">
                                ...
                                <div class="mb-3">
                                    <label for="name" class="form-label">Sub-To-Sub Name</label>
                                    <input type="text" class="form-control" id="name" name="name"
                                        placeholder="category name" value="<?php echo $subtosubcategory->name ?> ">
                                </div>

                                <div class="mb-3">
                                    <label for="description" name="description" class="form-label">Description</label>
                                    <input class="form-control" id="description" name="description"
                                        value="<?php echo $subtosubcategory->description ?>" rows=" 3"></input>
